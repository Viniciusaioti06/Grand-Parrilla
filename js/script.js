...
function showFormStatus(form,message){
  ...
  setTimeout(()=>status.classList.remove('show'),6500);
}
...
function sendWhatsApp(form, mode){
  ...
  showFormStatus(form, mode==='event' ? 'Orçamento preparado! O WhatsApp foi aberto para finalizar o envio.' : 'Reserva preparada! O WhatsApp foi aberto para finalizar o envio.');
  form.reset();
}
